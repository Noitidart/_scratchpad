...
var lib = ctypes.open('shcore');
var libk = ctypes.open('kernel32');

var SetProcessDpiAwareness = lib.declare('SetProcessDpiAwareness', ctypes.winapi_abi, ctypes.long, ctypes.unsigned_int);
var GetProcessDpiAwareness = lib.declare('GetProcessDpiAwareness', ctypes.winapi_abi, ctypes.long, ctypes.voidptr_t, ctypes.unsigned_int.ptr);
var GetCurrentProcess = libk.declare('GetCurrentProcess', ctypes.winapi_abi, ctypes.voidptr_t);
...
function main() {
	var val = ctypes.unsigned_int();
	var rez = GetProcessDpiAwareness(GetCurrentProcess(), val.address());
	console.info('rez:', rez, uneval(rez), rez.toString());
	console.info('getStrOfResult:', getStrOfResult(parseInt(rez.toString())), parseInt(rez.toString()));
...
function getStrOfResult(PrimitiveJS_RESULT) {
	var rezObj = {}
